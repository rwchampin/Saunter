...
const SignInScreen = () => {
  ...
  const btnSpring = useTransition({
    from: {bottom: open ? 0 : '85%', config: {delay: 0, duration: 0}},
    to: {top: open ? '85%' : 0, config: {delay: 4000, duration: 800}},
  });

  return (
    <AnimatedScreen style={{backgroundColor: 'purple'}}>
      <ImageBackground
