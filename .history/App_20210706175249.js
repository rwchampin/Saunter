...
import {createAnimatedSwitchNavigator} from '@react-navigation/stack';
import {Transition, animated, useSpring, config} from '@react-spring/native';
    ...
    <AnimatedScreen>
      <ImageBackground
        ...
        <animated.View style={btnSpring}>
          <Button
            style={{position: 'absolute', bottom: 0, margin: '0 auto'}}
            title="Sign in"
...
const Stack = createAnimatedSwitchNavigator(
  {SplashScreen, SignInScreen, HomeScreen1, HomeScreen2},
  {
...
const ootStack = createAppContainer(
